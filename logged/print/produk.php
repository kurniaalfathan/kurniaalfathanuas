...
mysql_select_db($database_olshop, $olshop);
$query_rs_kategori = "SELECT * FROM kategori WHERE id_kategori = $ta1";
...
<p></p>
<h3>Daftar Laporan Produk berdasarkan kategori <?php echo $row_rs_kategori['nama_kategori'];?></h3>
<hr />
  ...
  <thead>
    <tr>
      ...
      <th bgcolor="#333399"><div align="center" class="style1">DIBELI</div></th>
    ...
    <?php $no = 1; do { ?>
      <tr>
        ...
        <td><?php echo $e = $row_rs_product_print['dibeli']; ?></td>
