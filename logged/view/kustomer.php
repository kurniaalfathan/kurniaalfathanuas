...
<div class="list-group-item active">
		<h3>Halaman <strong>Kustomer</strong></h3>
</div>
<p></p>
<div>
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Daftar Kustomer</a></li>
    <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Add Kustomer</a></li>
  </ul>
