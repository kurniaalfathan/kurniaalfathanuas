      		...
      		<div class="panel-heading">Data pemesan beserta ordernya adalah sebagai berikut: <span class="badge"> No. Order : <?php echo $o = $row_rs_detail['id_orders']; ?></span></div>
	            <div class="panel-body">
                      <table width="467" height="97" class="table table-striped">
                        <tbody>
                          <tr>
                            <td width="131">Nama Lengkap</td>
                            <td width="324">: <strong><?php echo $row_rs_kustomer['nama_lengkap']; ?></strong></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td><?php if ($row_rs_detail['status_order'] == 'Baru') {
								echo "<div class='btn btn-lg btn-success'>Belum Lunas</div>";
							}else{
								echo "<div class='btn btn-lg btn-success'>Lunas</div>";
							} ?></td>
                          </tr>
                        </tbody>
                      </table>
...
<a href="print/kwitansi.php?v=<?php echo $row_rs_detail['id_orders']?>&x=<?php echo $row_rs_login['id_kustomer']?>" class="btn btn-xs btn-primary"><span class="glyphicon glyphicon-print"></span> Print</a>
        ...
        <div class="col-md-6">
         ...
         <p class="alert alert-warning">
              ...
              Anda dapat melakukan Konfirmasi Pembayaran Melalui SMS Ke NO : <strong>081275371724</strong> <br />
              Dengan Format : <strong>#No Orders #Nominal Transfer # Bank Tujuan # Bank Pengirim</strong> <br />
              Contoh : <strong>#<?php echo $o; ?> #<?php echo $gt = $tokir + $grand_total;?> #Mandiri #Riau</strong>
              <br />---------------------------------------------------------------------------
        ...
        <div class="col-md-6">
         <div class="page-header">
            ...
            <div class="row">
            	<div class="col-md-4"><img src="gambar/bank/bni.png" class="img-responsive" /><br /><strong>BNI <br />1909.8099.00.11</strong><br />A/n   : Muhammad Farhan</div>
                <div class="col-md-4"><img src="gambar/bank/bri.png" class="img-responsive" /><br /><strong>BRI <br />503.0292.22</strong><br />A/n   : Muhammad Farhan</div>
                <div class="col-md-4"><img src="gambar/bank/mandiri.png" class="img-responsive" /><br /><strong>Mandiri <br />09.8099.00.1</strong><br />A/n   : Muhammad Farhan</div>
            </div>
